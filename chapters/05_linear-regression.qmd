...
```{r echo = FALSE}
knitr::include_graphics(here::here("chapters", "images", "error-bars.png"))
...
Note: sometimes (a) is referred to as a [dynamite plot](https://simplystatistics.org/posts/2019-02-21-dynamite-plots-must-die/#:~:text=Dynamite%20plots%20are%20used%20to,regardless%20of%20the%20sample%20size.).
